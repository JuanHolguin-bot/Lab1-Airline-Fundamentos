...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './asiento.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASIENTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ASIENTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ASIENTO actions', async () => {
      const arg = { id: 27821 };
    ...
    it('dispatches UPDATE_ASIENTO actions', async () => {
      const arg = { id: 27821 };
    ...
    it('dispatches PARTIAL_UPDATE_ASIENTO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ASIENTO actions', async () => {
      const arg = 42666;
